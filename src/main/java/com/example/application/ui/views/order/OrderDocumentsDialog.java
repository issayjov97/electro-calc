...
public class OrderDocumentsDialog extends DocumentsDialog<OrderEntity> {

    public OrderDocumentsDialog(FileRepository fileRepository) {
    ...
    protected Component uploadFile() {
        ...
        upload.addSucceededListener(event -> {
            ...
            try {
                ...
                fileEntity.setOrderEntity(getEntity());
    ...
    protected void updateList() {
        ...
        filesGrid.setItems(fileRepository.findByOrderEntityId(getEntity().getId()));
    }
}
