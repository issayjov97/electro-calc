...
public class DemandDetailsDialog extends Div {
    ...
    private VerticalLayout createDialogLayout() {
        ...
        saveButton.addClickListener(event -> {
            fireEvent(new DemandDetailsDialog.SaveEvent(this, orderPatternsGrid.getSelectedItems()));
            close();
        });
        cancelButton.addClickListener(event -> {
            fireEvent(new DemandDetailsDialog.CloseEvent(this));
        });
    ...
    public static abstract class OrderDetailsDialogEvent extends ComponentEvent<DemandDetailsDialog> {
        private final Set<PatternEntity> patterns;

        protected OrderDetailsDialogEvent(DemandDetailsDialog source, Set<PatternEntity> patterns) {
            super(source, false);
    ...
    public static class SaveEvent extends OrderDetailsDialogEvent {
        SaveEvent(DemandDetailsDialog source, Set<PatternEntity> patterns) {
            super(source, patterns);
        }
    }

    public static class CloseEvent extends OrderDetailsDialogEvent {
        CloseEvent(DemandDetailsDialog source) {
            super(source, null);
        }
    }
